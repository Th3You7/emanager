...
const salesAction = () => async (dispatch) => {
  ...
  try {
    const { data } = await Axios.get(`${url}/api/sales/all`);
...
const addSalesAction = (data) => async (dispatch) => {
  ...
  try {
    ...
    const result = await Axios.post(`${url}/api/sales/add`, newData);
...
const deleteSaleAction = (id) => async (dispatch) => {
  ...
  try {
    const response = await Axios.delete(`${url}/api/sales/delete/${id}`);
...
const confirmSaleAction = (data) => async (dispatch) => {
  ...
  try {
    const result = await Axios.put(`${url}/api/sales/confirm`, data);
